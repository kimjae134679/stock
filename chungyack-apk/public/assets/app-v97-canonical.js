...
// v0.10.7: 찜/신청/결과는 중첩 상태이며 한 화면에서 다른 화면으로 '이동'시키지 않습니다.
window.CY_LATEST_VERSION='0.10.7-live';
...
function cyV97LoadV98(){cyV97Css('cyV98DesktopFixCss','assets/app-v98-desktop-fix.css?v=1070');cyV97Js('cyV98RuntimeFixScript','assets/app-v98-runtime-fix.js?v=1070')}
function cyV97LoadV99(){cyV97Css('cyV99ContactHoldCss','assets/app-v99-contact-hold.css?v=1070');cyV97Js('cyV99ContactHoldScript','assets/app-v99-contact-hold.js?v=1070')}
function cyV97LoadV100(){cyV97Js('cyV100HomeCurrentScript','assets/app-v100-home-current.js?v=1070')}
function cyV97LoadV101(){cyV97Css('cyV101MapFullResultCss','assets/app-v101-map-fullresult.css?v=1070');cyV97Js('cyV101MapFullResultScript','assets/app-v101-map-fullresult.js?v=1070')}
function cyV97LoadV102(){cyV97Js('cyV102FinanceRangesScript','assets/app-v102-finance-ranges.js?v=1070')}
function cyV97LoadV103(){cyV97Css('cyV103SortCss','assets/app-v103-sort.css?v=1070');cyV97Js('cyV103SortScript','assets/app-v103-sort.js?v=1070')}
function cyV97LoadV104(){cyV97Css('cyV104PcMobileCss','assets/app-v104-pc-mobile.css?v=1070');cyV97Js('cyV104PcMobileScript','assets/app-v104-pc-mobile.js?v=1070')}
function cyV97LoadV105(){cyV97Css('cyV105PcWideCss','assets/app-v105-pc-wide.css?v=1070');cyV97Js('cyV105PcWideScript','assets/app-v105-pc-wide.js?v=1070')}
function cyV97LoadV106(){cyV97Js('cyV106ExpiredHomeScript','assets/app-v106-expired-home.js?v=1070')}
function cyV97LoadV107(){cyV97Js('cyV107AdditiveStateScript','assets/app-v107-additive-state.js?v=1070')}
