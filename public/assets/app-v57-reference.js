...
function apply(root=document){
 ...
 root.querySelectorAll?.('#cycle-visual .v54-svg,#cycle-visual .v56w-svg').forEach(svg=>{
...
window.addEventListener('load',()=>{apply();setTimeout(apply,500);setTimeout(()=>{apply();mo.disconnect()},2200)});
})();
